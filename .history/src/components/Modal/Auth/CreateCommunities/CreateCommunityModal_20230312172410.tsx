						...
						>
							...
							<Box mt={4} mb={4}>
								...
								<Stack spacing={'2px'}>
									...
									>
                                        <Flex align={"center"}>
										<Text color={"yellow.800"} fontWeight={"600"} >Public</Text>
										<Text fontSize={"9pt"} ml="2" color={"yellow.800"} padding={"1"}  >Description</Text>
                                        </Flex>
									</Checkbox>
									<Checkbox
										name={'Private'}
									...
									>
                                        <Flex align={"center"}>
										<Text color={"yellow.800"} fontWeight={"600"} >Private</Text>
										<Text fontSize={"9pt"} ml="2" color={"yellow.800"} padding={"1"}  >Description</Text>
                                        </Flex>
									</Checkbox>
									<Checkbox
									...
									>
                                        <Flex align={"center"}>
										<Text color={"yellow.800"} fontWeight={"600"} >Restricted</Text>
										<Text fontSize={"9pt"} ml="2" color={"yellow.800"} padding={"1"}  >Description</Text>
                                        </Flex>
									</Checkbox>
								</Stack>

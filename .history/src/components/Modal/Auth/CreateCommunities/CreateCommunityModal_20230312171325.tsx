				...
				<ModalContent>
					...
					<Box padding={6}>
						...
						>
                            ...
                            <Box mt={4} mb={4}>
                               <Text fontWeight={"600"} color={"yellow.800"} fontSize={"16px"}>
                                Community Type
                                </Text> 
                                {/* <checkbox/> */}
                                <Stack spacing={"2px"}>
                                    <Checkbox name={"Public"} isChecked={communityType === "Public"}>Public</Checkbox>
                                    <Checkbox name={"Private"} isChecked={communityType === "Private"}>Private</Checkbox>
                                    <Checkbox name={"Restricted"} isChecked={communityType === "Restricted"}>Restricted</Checkbox>
                                </Stack>
                            </Box>
						</ModalBody>
					</Box>

	...
	return (
		<>
			<Modal isOpen={open} onClose={handleClose} size={'2xl'}>
				<ModalOverlay />
				<ModalContent>
					<ModalHeader color={'yellow.800'}>Create A Community</ModalHeader>
					<Box padding={6}>
						<ModalCloseButton />
						<ModalBody
							display={'flex'}
							...
							padding={'10px 0px'}
						>
							<Text fontWeight={'900'} fontSize={'16pt'} color={'yellow.800'}>
								Name
							</Text>
							...
							<Input
                                ...
                                _hover={{outlineColor:"yellow.700", outline:"0.5px #0a050f"}}
							/>
							<Text
					...
					<ModalFooter bg={'yellow.100'} borderRadius={'0px 0px 10px 10px'}>
						<Button
							variant={'outline'}
							colorScheme="blue"
							mr={3}

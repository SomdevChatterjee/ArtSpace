...
const About: React.FC<AboutProps> = ({ communityData }) => {
  const selecteFileRef = useRef<HTMLInputElement>(null);
  ...
  const[,setComunityStateValue] = useRecoilState(communityState)
  const [user] = useAuthState(auth);
  const comunityStateValue = useRecoilValue(communityState)
  const onUpdateImage = async () => {
    ...
    try {
      ...
      console.log("communityImageUploadingError: ", error.message)
    }
      ...
      <Flex>
        ...
        >
          <Stack>
            ...
            <Link href={`/A/${communityData.id}/Submit`}>
                ...
                <Stack spacing={1} fontSize="10pt">
                  ...
                  <Flex align={"center"} justify="space-between">
                    <Text
                      ...
                      onClick={() => selecteFileRef.current?.click()}
                    >
                      Change Image
                    </Text>

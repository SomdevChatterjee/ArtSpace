            ...
            {homePage && (
              <>
                {post.communityImageUrl ? (
                  ...
                  <Icon as={FaReddit} fontSize={"18pt"} mr={1} color={"yellow.500"} />
                )}
				<Link href={`A/${post.communityId}`}/>
				<Text fontWeight={700} _hover={{textDecoration:"underline"}}>{`A/${post.communityId}`}</Text>
              </>
            )}
            <Text>

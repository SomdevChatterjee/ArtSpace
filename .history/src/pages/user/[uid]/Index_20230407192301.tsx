...
const Index:React.FC<IndexProps> = () => {
    ...
    <>
     <Flex width={"100%"} bg={"white"} padding="10px" borderRadius={"5px"} align="center" justify={"space-between"}>
        <Flex>
        <Icon as={BsFire}/>
        <Text fontWeight={700} color={"blackAlpha.500"} _hover={{color:"yellow.500"}}>New</Text>

        </Flex>
        <Flex color={"blackAlpha.500"} _hover={{borderRadius:"20px", color:"yellow.500"}} padding="">
        <Icon as={BsFire}/>

...
const Index:React.FC<IndexProps> = () => {
      ...
      try {
        if (communityStateValue.mySnippets.length) {
          ...
          const postQuery = query(
            ...
            where("creatorId", "in", myCommunityIds),
          );
    ...
    return (
      <IndexContentLayout>
        <>
        <Flex width={"100%"} bg={"white"} padding="10px" borderRadius={"5px"} align="center" justify={"flex-start"} height="50px" mb={2}>
